...
console.log(dinosaurOne.weigth);
...
const unisWithUni = [];
const placeHolder = graduates.filter(element => element.university.includes('Uni'));
placeHolder.forEach(element => unisWithUni.push(element.university));
